...
def default_partition(
    ...
    """
    # it give separate forward and backward graph modules.
    ...
    fwd_outputs, bwd_outputs = _extract_fwd_bwd_outputs(joint_module, num_fwd_outputs=num_fwd_outputs) # [cos_1]
